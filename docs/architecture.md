...
- **Action pinning**: third-party GitHub Actions are pinned to commit SHAs where practical.
- **No public AI triggers**: Claude review automation is not wired into public issue or PR comments.
